...
/*
Criar uma função que conte os elementos de uma
árvore binária de pesquisa.
==============================================
Criar um procedimento que mostre na tela as
folha de uma árvore binária de pesquisa.
*/
...
int conta_nodos(struct BSTNode *raiz); //função inserida pra contar nodos do programa 
...
int conta_nodos(struct BSTNode *raiz){
        ...
        return 0;
            ...
            p=raiz;
            if(p!=NULL)
            return 1 + conta_nodos(p->esquerda) + conta_nodos(p->direita);
        }
    }
